    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Production-ready ML systems with proven business impact</p>
        </div>
            ...
            >
              {project.featured && (
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-bold text-yellow-600 uppercase tracking-wide">Featured Project</span>
                </div>
              )}

              <div className="flex justify-between items-start mb-4">
                <h3 className="text-2xl font-bold text-gray-900 flex-1 pr-4">{project.title}</h3>
              ...
              <div className="mb-4 bg-green-50 p-4 rounded-lg border border-green-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.metrics.map((metric, mIdx) => (
                    <span key={mIdx} className="px-3 py-1 bg-green-600 text-white rounded-full text-xs font-bold">
                      {metric}
                    </span>
                  ))}
                </div>
              ...
              <div className="mb-4 bg-blue-50 p-4 rounded-lg border border-blue-200">
                <p className="text-sm font-bold text-blue-900 mb-2">Business Impact</p>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, techIdx) => (
                    <span key={techIdx} className="px-3 py-1 bg-gray-100 text-gray-800 rounded-lg text-xs font-semibold border border-gray-300">
                      {tech}
                    </span>
                  ))}
                </div>
